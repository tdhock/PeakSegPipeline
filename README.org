...
Install UCSC command line programs, [[https://github.com/tdhock/PeakSegPipeline/wiki/FAQ#installing-ucsc-command-line-programs][as explained on our FAQ]].

Install a C++ compiler and a BerkeleyDB STL development library. On
my Ubuntu system the command looks like this:

#+BEGIN_SRC shell-script
sudo aptitude install build-essential r-recommended libdb6.0++-dev libdb6.0-stl-dev
#+END_SRC
...
install BerkeleyDB by hand to your home directory -- see [[https://github.com/tdhock/PeakSegPipeline/wiki/FAQ#compiler-installation-problems][our FAQ on
Compiler installation problems which explains how to do this on Unix
and MacOS]].
